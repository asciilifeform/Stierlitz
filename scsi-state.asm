...
MSC_CBW_Signature_lw		EQU	(cbw_receive_buffer)
MSC_CBW_Signature_uw		EQU	(cbw_receive_buffer + 2)
CBW_tag_lw			EQU	(cbw_receive_buffer + 4)
CBW_tag_uw			EQU	(cbw_receive_buffer + 6)
CBW_data_transfer_length_lw	EQU	(cbw_receive_buffer + 8)
CBW_data_transfer_length_uw	EQU	(cbw_receive_buffer + 10)
CBW_flags			EQU	(cbw_receive_buffer + 12)
CBW_lun				EQU	(cbw_receive_buffer + 13)
CBW_cb_length			EQU	(cbw_receive_buffer + 14)
CBW_cb				EQU	(cbw_receive_buffer + 15)
;*****************************************************************************
